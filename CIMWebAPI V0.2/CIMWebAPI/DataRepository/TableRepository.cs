    ...
    public class TableRepository
    {
        ...
        public DataTable MapTablePresence(DataTable table, OutQueuePhone data)
        {
            try
            {
                ...
                Row["PRIORITY"] = (data.Priority == 0) ? 5000 : data.Priority;
                //Applies LIFO rule
        ...
        public DataTable MapLoadTable(DataTable table, OutQueuePhone data)
        {
            try
            {
                ...
                Row["LOADID"] = data.LoadID;
                Row["STATUS"] = 'D';
                Row["DESCRIPTION"] = (data.LoadDescription == null || data.LoadDescription == "") ? "APIBatchLoad" + Convert.ToString(DateTime.Now) : data.LoadDescription;
                Row["RDATE"] = DateTime.Now;
