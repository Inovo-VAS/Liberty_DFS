    ...
    class NumberOps
    {
        ...
        public string FormatNumber(string inPhone)
        {
            try
            {
                ...
                if (inPhone.Length==10 && inPhone.StartsWith("0"))
                {
                    inPhone = inPhone.Substring(1);
                }
                if (inPhone != String.Empty)
                {
                    ...
                    if (inPhone != String.Empty && inPhone.Length>9)
                    {
                    ...
                    if(inPhone != String.Empty)
                    {
                        inPhone = inPhone.Length>9? (inPhone.Substring(0, 3) == "264" || inPhone.Substring(0, 3) == "268" || inPhone.Substring(0, 3) == "267") ? "0" + inPhone : inPhone:inPhone;
                        inPhone = inPhone.Length > 9 ? (inPhone.Substring(0, 3) == "648") ? "02" + inPhone : inPhone : inPhone;
                    }
                    inPhone = (inPhone.Length < 9) ? String.Empty : inPhone;
                }
                return inPhone;
